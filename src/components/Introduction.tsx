...
import { calculateTimeToLeft } from "../utils/timer";

const Introduction = () => {
    const [timeLeft, setTimeLeft] = useState(calculateTimeToLeft());
    
    useEffect(() => {
        const interval = setInterval(() => {
            setTimeLeft(calculateTimeToLeft());
        }, 1000);
    ...
    return (
        <div className="mt-14 flex flex-col">
            <div>
                <h1 className="font-medium">DEV TRIVIA</h1>
            ...
            <div className="w-fit my-3 flex flex-col gap-1 justify-center">
                <h1 className="font-medium">--- Next game starts in ---</h1>
